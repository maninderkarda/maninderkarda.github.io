...
export const projectsData: ProjectDetails[] = [
  {
    ...
    githubLink: "https://github.com/maninderkarda/Churn-and-Calls-Analysis-Connect_Broadband",
  ...
  },
  {
    ...
    icon: BarChart3,
    tech: ["Power BI", "DAX", "SQL Server", "Power Query", "Data Modeling ", "Sales Analytics", "Inventory Management", "Stock Coverage Analysis", "Distributor Analytics", "Supply Chain Analytics"],
  ...
  },
  {
    ...
    icon: TrendingUp,
    tech: ["Power BI", "DAX", "Excel", "Product Performance Analysis", "Sales Performance Analysis", "Web Analytics", "Customer Engagement Analysis", "Revenue Analysis"],
